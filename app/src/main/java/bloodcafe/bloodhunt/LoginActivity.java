...
public class LoginActivity extends AppCompatActivity {
    ...
    LinearLayout btnsingInWithGoogle,btnsignInWithFacebook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsignInWithFacebook=findViewById(R.id.btn_sign_in_facebook);
        btnsingInWithGoogle=findViewById(R.id.btn_sign_in_google);
            ...
            public void onClick(View v) {
                ...
                LoginManager.getInstance().registerCallback(callbackManager,
                        new FacebookCallback<LoginResult>()
                        {
                            ...
                            {
                                // App code
                                Log.i(TAG,"facebook:failed:"+ exception.getMessage());
                            }
                        });
            }
        });
